...
Download the Global Historical Climatology Network daily (GHCNd) inventory data using `fetch_ghcnd_inventory.py <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/blob/master/scripts/fetch_ghcnd_inventory.py>`_.
This script will download `ghcnd-inventory.txt <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/raw/master/data/ghcnd-inventory.txt>`_ and create the ghcnd_inventory table in `data.db <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/raw/master/data/data.db>`_.
...
Using `fetch_ncdc_prcp_stations.py <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/blob/master/scripts/fetch_ncdc_prcp_stations.py>`_ and `fetch_ncdc_evap_stations.py <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/blob/master/scripts/fetch_ncdc_evap_stations.py>`_, fetch information about PRCP and EVAP stations from the CDO database.
These two scripts will create `ncdc_prcp_stations.json <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/raw/master/data/ncdc_prcp_stations.json>`_ and `ncdc_evap_stations.json <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/raw/master/data/ncdc_evap_stations.json>`_.
...
The following command will create `input_evap.txt <https://github.com/HuidaeCho/omu-2024-r.topmodel-workshop/raw/master/data/input_evap.txt>`_ that can directly be passed to ``r.topmodel input=``.
